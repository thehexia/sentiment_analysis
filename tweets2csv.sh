...
do
	...
	cat "tweets/EST_tweets/by_day/"$dir"/csv/"*.csv > "tweets/EST_tweets/by_day/"$dir"/csv/"merge.csv;
done
...
do
	...
	cat "tweets/EST_tweets/by_hour/"$dir"/csv/"*.csv  > merge.csv;
done
...
do
	...
	cat "tweets/PST_tweets/by_day/"$dir"/csv/"*.csv  > merge.csv;
done
...
do
	...
	cat "tweets/PST_tweets/by_hour/"$dir"/csv/"*.csv  > merge.csv;
done
...
do
	...
	cat "tweets/CT_tweets/by_day/"$dir"/csv/"*.csv  > merge.csv;
done
...
do
	...
	cat "tweets/CT_tweets/by_hour/"$dir"/csv/"*.csv  > merge.csv
done